  ...
  return (
    <div className="grid min-h-[60vh] place-items-center text-center">
      <div>
        ...
        <Link className="mt-5 inline-flex min-h-10 items-center justify-center rounded-lg bg-primary-light px-4 text-sm font-semibold text-white hover:bg-blue-600 dark:bg-primary-dark dark:text-slate-950" to="/dashboard">
          Back to dashboard
        </Link>
      </div>
    </div>
