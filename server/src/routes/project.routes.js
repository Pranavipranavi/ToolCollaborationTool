...
import { archiveProject, createProject, deleteProject, listProjects, projectRules, updateProject } from "../controllers/project.controller.js";
...
projectRouter.patch("/:workspaceId/projects/:projectId", requireWorkspaceRole("Owner", "Admin"), updateProject);
projectRouter.patch("/:workspaceId/projects/:projectId/archive", requireWorkspaceRole("Owner", "Admin"), archiveProject);
projectRouter.delete("/:workspaceId/projects/:projectId", requireWorkspaceRole("Owner", "Admin"), deleteProject);
